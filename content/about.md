...
roadmap_heading: Where we are now
roadmap_body: >-
  The club is brand new. These are the concrete things we are working through
...
gerontology and geriatrics at Weill, in health tech at Cornell Tech. Very little
of it is connected, and almost none of it is legible to an undergraduate trying
to find a way in.

The Cornell Longevity Association is our attempt to fix that. We want to be the
place where a sophomore who just read a paper on cellular senescence, a
...
Everything is open to any Cornell student, on any campus, from any major. There
is no application to be a general member and no background in biology required.
